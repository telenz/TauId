...
root -b -l <<EOF > results_VVLooseDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_VVLooseDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF

root -b -l <<EOF > results_VLooseDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_VLooseDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF

root -b -l <<EOF > results_LooseDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_LooseDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF

root -b -l <<EOF > results_MediumDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_MediumDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF

root -b -l <<EOF > results_TightDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_TightDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF

root -b -l <<EOF > results_VTightDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_VTightDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF

root -b -l <<EOF > results_VVTightDeepTau2017v2p1.txt
TFile *_file0 = TFile::Open("fitDiagnostics_VVTightDeepTau2017v2p1.root")
fit_s->Print()
fit_s->correlation("tauId","r")
EOF
...
wps=("VVLooseDeepTau2017v2p1" "VLooseDeepTau2017v2p1" "LooseDeepTau2017v2p1" "MediumDeepTau2017v2p1" "TightDeepTau2017v2p1" "VTightDeepTau2017v2p1" "VVTightDeepTau2017v2p1")
