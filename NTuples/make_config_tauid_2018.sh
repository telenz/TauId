...
sed 's/TauMomScale = 1./TauMomScale = 0.98/' analysisNTupleProducer_tauid_MC_2018.conf > analysisNTupleProducer_tauid_MC_2018_tauesDown_WStarTauNu.conf

sed 's/TauMomScale = 1./TauMomScale = 1.02/' analysisNTupleProducer_tauid_MC_2018.conf > analysisNTupleProducer_tauid_MC_2018_tauesUp_WStarTauNu.conf
